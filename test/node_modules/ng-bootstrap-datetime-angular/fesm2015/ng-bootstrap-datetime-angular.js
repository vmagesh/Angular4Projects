 ...
 */
class NgBootstrapDatetimeAngularService {
    constructor() { }
}
...
/** @nocollapse */
NgBootstrapDatetimeAngularService.ctorParameters = () => [];
...
class NgBootstrapDatetimeAngularComponent {
    /**
     * @param {?} config
     * @param {?} inj
     */
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class NgBootstrapDatetimeAngularModule {
}
